...
const tohex = Object.keys(mek.message)[0] == "stickerMessage" ? mek.message.stickerMessage.fileSha256.toString('hex') : ""
...
sjdl = isQuotedSticker ? JSON.parse(JSON.stringify(vnz).replace('quotedM', 'm')).message.stickerMessage.contextInfo : vnz
